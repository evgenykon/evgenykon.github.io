                ...
                <div class="container">
                  ...
                  <nav class="panel">
                    ...
                    <div class="panel-block container p-0">
                      <div class="column py-1">
                        <span class="tag is-primary is-light mr-1"
                              v-for="skill of $page.CvDoc.skills"> {{ skill.name }} </span>
                      </div>
                    </div>
                  </nav>
                  ...
                  <nav class="panel">
                    ...
                    <a class="panel-block" v-for="item of $page.CvDoc.achivements" v-bind:href="item.url">
                            <span class="panel-icon">
                              <g-image alt="achivement" src="https://www.svgrepo.com/show/382123/achivement.svg"
                                       width="30"/>
                            </span>
                      {{ item.name }}
...
@media print {
  html,body { margin: 0; }
  .section, .container, .column, .card, .card-content {
    padding: 5px;
  }
  .right-sidebar {
    max-width: 250px;
